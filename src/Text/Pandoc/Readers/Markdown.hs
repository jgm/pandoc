...
likelyAbbrev x =
  let abbrevs = [ "A.M.", "a.m.", "abbr.", "abl.", "abr.", "acc.",
                  "act.", "add.", "adj.", "adv.", "aet.", "aetat.",
                  "AFr.", "al.", "Ala.", "Alas.", "Alta.", "anon.",
                  "Apoc.", "app.", "arch.", "Ariz.", "Ark.",
                  "art.", "Ave.", "b.", "B.C.", "Bar.", "Bd.",
                  "bib.", "bibl.", "bibliog.", "biog.", "biol.",
                  "bk.", "Bldg.", "c.", "ca.", "Calif.", "Cantab.",
                  "Cantuar.", "Capt.", "cet.", "Cf.", "cf.", "ch.",
                  "chap.", "Chron.", "cit.", "Col.", "col.",
                  "colloq.", "Colo.", "comm.", "comp.", "compar.",
                  "con.", "conj.", "Conn.", "cons.", "constr.",
                  "cont.", "contr.", "cop.", "Cor.", "corr.",
                  "cp.", "Ct.", "d.", "D.C.", "d.h.", "d.i.",
                  "Dan.", "dat.", "def.", "Del.", "dept.",
                  "deriv.", "Deut.", "dial.", "dict.", "dim.",
                  "dist.", "div.", "do.", "Dr.", "dram.", "e.g.",
                  "ea.", "Eccles.", "Ecclus.", "ed.", "ellipt.",
                  "ency.", "encyc.", "Eng.", "eng.", "engr.",
                  "enl.", "Eph.", "eq.", "Esd.", "esp.", "etc.",
                  "ex.", "Exod.", "Expy.", "Ezek.", "f.", "f.v.",
                  "fasc.", "fem.", "ff.", "fig.", "fl.", "Fla.",
                  "fol.", "fols.", "Fr.", "fr.", "fut.", "G.",
                  "Ga.", "Gael.", "Gal.", "Gen.", "gen.", "geog.",
                  "geol.", "geom.", "Ger.", "ger.", "Gk.", "Gov.",
                  "Hab.", "Hag.", "Heb.", "hist.", "Hon.", "Hwy.",
                  "i.e.", "Ibid.", "ibid.", "id.", "Ill.", "ill.",
                  "imp.", "imper.", "incl.", "Ind.", "indef.",
                  "indic.", "inf.", "infin.", "init.", "inst.",
                  "instr.", "int.", "interj.", "intrans.",
                  "intro.", "introd.", "irreg.", "Isa.", "It.",
                  "Jer.", "Jon.", "Josh.", "Jth.", "Judg.",
                  "Kans.", "Ky.", "L.", "l.", "La.", "Lam.",
                  "lang.", "Lat.", "Lev.", "lib.", "lit.", "ll.",
                  "Ln.", "loc.", "loq.", "M.", "m.", "M.A.",
                  "M.D.", "m.m.", "Macc.", "Mal.", "Man.", "marg.",
                  "masc.", "Mass.", "math.", "Matt.", "Md.",
                  "Messrs.", "Mic.", "Mich.", "mimeo.", "Minn.",
                  "misc.", "Miss.", "Mo.", "Mod.E.", "Mont.",
                  "Mr.", "Mrs.", "Ms.", "mus.", "n.", "N.B.",
                  "n.b.", "N.C.", "n.d.", "N.Dak.", "N.H.", "N.J.",
                  "N.Mex.", "n.p.", "N.S.", "n.s.", "N.W.T.",
                  "N.Y.", "Nah.", "nat.", "Neb.", "Nebr.", "neg.",
                  "Neh.", "neut.", "Nev.", "Nfld.", "no.", "nom.",
                  "nos.", "Num.", "Nun.", "Nvt.", "o.s.", "ob.",
                  "Obad.", "obs.", "occas.", "OFr.", "Okla.",
                  "Ont.", "op.", "Ore.", "Oreg.", "Oxon.", "p.",
                  "P.E.I.", "P.M.", "p.m.", "p.p.", "P.Q.", "P.R.",
                  "Pa.", "pa.", "par.", "para.", "pass.", "path.",
                  "perf.", "perh.", "pers.", "Pet.", "Ph.D.",
                  "Phil.", "Philem.", "Pkwy.", "Pl.", "pl.", "pp.",
                  "ppl.", "Pr.", "pr.", "prep.", "Pres.", "pres.",
                  "Prof.", "pron.", "Prov.", "prox.", "Ps.",
                  "Pss.", "pt.", "pub.", "q.v.", "quar.", "quart.",
                  "Que.", "R.", "r.", "R.I.", "Rd.", "refl.",
                  "Rep.", "repr.", "Rev.", "rev.", "Rm.", "Rom.",
                  "Rte.", "s.", "s.a.", "S.C.", "s.d.", "S.Dak.",
                  "s.h.", "s.l.", "s.n.", "s.p.", "s.v.", "s.vv.",
                  "Sam.", "Sask.", "Sc.", "sc.", "Scot.", "sd.",
                  "sec.", "Sen.", "seq.", "ser.", "sg.", "Sgt.",
                  "sing.", "Sir.", "sociol.", "Sol.", "Sp.", "Sq.",
                  "St.", "st.", "Ste.", "subj.", "subst.", "sup.",
                  "superl.", "supp.", "suppl.", "syn.", "t.",
                  "t.p.", "techn.", "tem.", "Tenn.", "Ter.",
                  "Terr.", "Tex.", "theol.", "Thess.", "Tim.",
                  "Tob.", "trans.", "treas.", "u.", "U.S.", "ult.",
                  "univ.", "usw.", "v.", "V.I.", "v.i.", "v.t.",
                  "Va.", "vb.", "viz.", "voc.", "vol.", "vols.",
                  "Vrl.", "vs.", "Vt.", "W.Va.", "Wash.", "Wis.",
                  "Wisc.", "Wisd.", "Wyo.", "yr.", "Yuk.", "Zech.",
                  "Zeph."]
