...
```
% pandoc --wrap=none -f latex -t markdown_strict+raw_html --markdown-headings=setext
This has \textsc{small caps} in it.
^D
This has <span class="smallcaps">small caps</span> in it.
```
...
```
% pandoc --wrap=none -f html -t markdown_strict-raw_html-strikeout --markdown-headings=setext
This has <s>strikeout</s> in it.
^D
This has strikeout in it.
```
...
```
% pandoc --wrap=none -f html -t markdown_strict-raw_html-superscript --markdown-headings=setext
This has <sup>superscript</sup> in it and <sup>2</sup> again.
^D
...
```
% pandoc --wrap=none -f html -t markdown_strict-raw_html-subscript --markdown-headings=setext
This has <sub>subscript</sub> in it and <sub>2</sub> again.
^D
