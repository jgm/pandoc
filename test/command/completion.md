...
_pandoc() {
  ...
  args=(
    ...
    '--data-dirs[Additional directories for data files]:DIRECTORIES:_files'
...
complete -c pandoc -l data-dirs -d "Additional directories for data files" -r
